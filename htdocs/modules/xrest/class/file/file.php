...
class IcmsFileHandler
{
    ...
    {
        include_once dirname(__FILE__).'/icmsfile.php';
        $this->folder = IcmsFile::getHandler('folder', dirname($path), $create, $mode);
        if (!is_dir($path)) {
    ...
    /**
     * IcmsFileHandler::IcmsFileHandler()
     *
     * @param mixed $path
     * @param mixed $create
     * @param mixed $mode
     */
    function IcmsFileHandler($path, $create = false, $mode = 0755)
    {
