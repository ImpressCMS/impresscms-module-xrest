    ...
    function renderIndex()
    {
        ...
        if ($this->_obj->getInfo('min_php') || $this->_obj->getInfo('min_xoops') || !empty($this -> _itemConfigBoxLine)){
            ...
            if ($this->_obj->getInfo('min_xoops')){
                if (substr(ICMS_VERSION, 6, strlen(ICMS_VERSION)-6) < $this->_obj->getInfo('min_xoops')){
                    $ret .= "<span style='color : red; font-weight : bold;'><img src='" . $path . "off.png' >" . sprintf(_AM_MODULEADMIN_CONFIG_ICMS, $this->_obj->getInfo('min_xoops'), substr(ICMS_VERSION, 6, strlen(ICMS_VERSION)-6)) . "</span>\n";
                }else{
                    $ret .= "<span style='color : green;'><img src='" . $path . "on.png' >" . sprintf(_AM_MODULEADMIN_CONFIG_ICMS, $this->_obj->getInfo('min_xoops'), substr(ICMS_VERSION, 6, strlen(ICMS_VERSION)-6)) . "</span>\n";
                }
                $ret .= "<br />";
            }
