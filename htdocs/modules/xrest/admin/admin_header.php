 ...
 */
	...
	if ( file_exists((ICMS_ROOT_PATH.'/modules/xrest/class/moduleclasses/moduleadmin/moduleadmin.php'))){
	        include_once (ICMS_ROOT_PATH.'/modules/xrest/class/moduleclasses/moduleadmin/moduleadmin.php');
	        //return true;
	    }else{
	...
	if (icms::$user) {
	    ...
	    if (!$moduleperm_handler->checkRight('module_admin', $GLOBALS['xrestModule']->getVar( 'mid' ), icms::$user->getGroups())) {
	...
	include_once (ICMS_ROOT_PATH.'/modules/xrest/include/common.php');
	include_once (ICMS_ROOT_PATH.'/modules/xrest/include/functions.php');
	include_once (ICMS_ROOT_PATH.'/modules/xrest/include/forms.xrest.php');
	
	if (!class_exists('IcmsCache')) {	require_once(ICMS_ROOT_PATH.'/modules/xrest/class/cache/icmscache.php'); }
	
	if (file_exists(ICMS_ROOT_PATH.''.DS.'modules'.DS.'xrest'.DS.'language'.DS.$GLOBALS['icmsConfig']['language'].DS.'admin.php'))
		include_once (ICMS_ROOT_PATH.''.DS.'modules'.DS.'xrest'.DS.'language'.DS.$GLOBALS['icmsConfig']['language'].DS.'admin.php');
	
	IF (!@ include_once XOOPS_ROOT_PATH."/libaries/art/functions.admin.php"):    
